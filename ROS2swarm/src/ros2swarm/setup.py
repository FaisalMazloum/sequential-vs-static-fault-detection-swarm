...
setup(
    ...
    packages=[
    package_name,
    package_name + '.movement_pattern',
    package_name + '.movement_pattern.basic',
    package_name + '.movement_pattern.combined',
    package_name + '.voting_pattern',
    package_name + '.voting_pattern.basic',
    package_name + '.sensor_layer',
    package_name + '.utils',
],
    data_files=[
    ...
    entry_points={
        'console_scripts': [
            ...
            'adaptive_sampling_pattern = '
            'ros2swarm.movement_pattern.basic.adaptive_sampling_pattern:main',
