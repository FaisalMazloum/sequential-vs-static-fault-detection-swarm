#include "remora_controller/simple_controller.hpp"
                                  ...
                                  , theta_(0.0)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
